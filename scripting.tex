...
\begin{emphbox}
\begin{lstlisting}[style=Pseudomath]
<Director's signature> <CFO's signature> 2 <Director's Public Key>
<CFO's Public Key> <COO's Public Key> 3 CHECKMULTISIG
\end{lstlisting}
\end{emphbox}
...
\subsection*{Create a P2SH address based on a P2PK script}
...
\subsection*{Spend funds from a P2SH address}
